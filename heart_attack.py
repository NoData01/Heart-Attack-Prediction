# -*- coding: utf-8 -*-
"""
Created on Tue Jun 21 09:22:56 2022
...
#%% Discussion
# From this model, around 78% accuracy can be achieved during training.
# where MinMaxScaler and LogisticRegression have been choosed through pipeline 
# to be the best scaler and training model.

# Although the accuracy only around 78%, it can be improved by adding more 
# data to it.
